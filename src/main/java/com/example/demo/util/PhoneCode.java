...
public class PhoneCode {
    ...
    // 替换成你的AK (产品密)
    final static String accessKeyId = "LTAI4FyTekPW2CvL2TCPaZ1M";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
    final static String accessKeySecret = "sasGYgH7JcyMaytfCtbHQto4yKTOTW";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    // 必填:短信签名-可在短信控制台中找到
    final static String SignName = "少晨蛋糕店";// 阿里云配置你自己的短信签名填入
    // 必填:短信模板-可在短信控制台中找到
    final static String TemplateCode = "SMS_192340002"; // 阿里云配置你自己的短信模板填入

    private static String code;

    public static void main(String[] args) {
        String phone = "18533090227"; //此处可输入你的手机号码进行测试
